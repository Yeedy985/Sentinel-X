...
const navItems = [
  { href: '/admin/dashboard', label: '仪表盘', icon: BarChart3, color: 'text-emerald-400' },
  { href: '/admin/dashboard/signals', label: '信号矩阵', icon: Zap, color: 'text-yellow-400' },
  { href: '/admin/dashboard/pipelines', label: 'LLM 管线', icon: Cpu, color: 'text-purple-400' },
